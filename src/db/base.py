...
# Supabase owns this table. Declaring only its stable primary key lets SQLAlchemy
# resolve application foreign keys without attempting to manage the auth schema.
AUTH_USERS = Table(
    "users",
    Base.metadata,
