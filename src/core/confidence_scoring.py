...
from src.core.score_explanations import build_score_explanation
from src.data.patient_history import prepare_history_context
from src.core.safety_rules import VITAL_FIELDS, apply_safety_ceiling, evaluate_safety_rules
