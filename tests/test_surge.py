...
from resilicare import COMBAT_MODE_QUEUE_THRESHOLD, replay_arrivals

PATIENTS = json.loads((Path(__file__).parents[1] / "data" / "simulated_patients.json").read_text(encoding="utf-8"))["patients"]
